            ...
            <div className="w-full md:w-5/12">
              <div className="glass-panel p-8 rounded-[24px]">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <span className="md:hidden font-label-sm text-label-sm text-on-surface-variant border border-outline-variant px-2 py-1 rounded">
                    Jan 2026 - June 2026
                  </span>
                </div>
                <ul className="font-body-md text-body-md text-on-surface-variant space-y-2 list-disc list-inside">
                  ...
                  <li>Improved core web vitals by 41% across flagship products.</li>
                </ul>
              </div>
            </div>
          </motion.div>
