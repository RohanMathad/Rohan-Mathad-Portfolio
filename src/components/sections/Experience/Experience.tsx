...
export const Experience: React.FC = () => {
  return (
    <section id="experience" className="scroll-mt-32 w-full max-w-container-max mx-auto md:px-margin-desktop mb-24 md:mb-0 hidden md:block">
      <div className="flex flex-col items-center mb-16 text-center md:text-left">
            ...
            <div className="w-full md:w-5/12">
              <div className="glass-panel p-8 rounded-[24px]">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <h3 className="font-headline-md text-headline-md text-xl mb-1">Senior Frontend Engineer</h3>
                    <p className="font-body-md text-body-md text-primary-fixed-dim">Coditas Solutions LLP</p>
                  </div>
                  <span className="font-label-sm text-label-sm text-on-surface-variant border border-outline-variant px-2 py-1 rounded">2021 - Present</span>
                </div>
                <ul className="font-body-md text-body-md text-on-surface-variant space-y-2 list-disc list-inside">
                  <li>Architected and migrated legacy monolith to micro-frontends.</li>
                  <li>Mentored a team of 5 junior developers.</li>
                  <li>Improved core web vitals by 40% across flagship products.</li>
                </ul>
              </div>
            </div>
          </motion.div>
