    ...
    <footer 
      ...
      >
        <div className="text-center mb-12">
          ...
          <a href="mailto:mathadrohan72@gmail.com" className="font-body-lg text-body-lg text-primary hover:text-white underline underline-offset-8 transition-colors">Get in Touch</a>
        </div>
